...
$(".test-entry").each(function () {
    ...
    $(this).attr('data-count', function (index) {
        return cnt1;
    });
    cnt1++;
...
$('#count-sum').html(test_entry_count);
...
$(window).scroll(function () {
    $('.test-entry').each(function () {
        if (isScrolledIntoView(this) === true) {
           ...
           var active_ = $(this).attr('data-count');

            // $('#count').attr('data-count', function (index) {
            //     return cnt1;
            // });
            $('#count').html(active_);
            console.log(active_)
...
$(".accordion-trigger").click(function () {
    ...
    if (trig.hasClass("accordion-active")) {
        ...
        trig.find('.button-accordion').removeClass('clicked');
       ...
       // $('.btn-accordion').html(label_more);
        ...
        $('.button-accordion').removeClass('clicked');
        trig.next(".accordion-container").slideToggle("slow");
        ...
        $(".content-accordion .accordion-trigger")
            ...
            .removeClass("open");
       // $('.btn-accordion').html(label_more);
        trig.find('.button-accordion').addClass('clicked');
...
(function($){
    $(window).on("load",function(){
        $(".header-navigation-submenu").mCustomScrollbar();
    });
})(jQuery);
