...
$(".header-navigation nav ul li a:first-child").each(function () {
    $(this).click(function () {
        if ($('header').hasClass('menu-open')) {
            $('header').removeClass('menu-open');    
            $('.header-navigation-submenu').removeClass('menu-open');  
            $('.header-navigation-lessons').removeClass('menu-open');  
...
$(".header-navigation nav ul li a:nth-child(2)").each(function () {
    $(this).click(function () {
        if ($('header').hasClass('menu-open')) {
            $('header').removeClass('menu-open');    
            $('.header-navigation-tests').removeClass('menu-open');  
            $(".header-navigation nav ul li a").removeClass('current');  
            $(this).removeClass('current');
        } else {
            $('header').addClass('menu-open');
...
$('.header-navigation-submenu .btn-close').click(function () {
    if ($('header').hasClass('menu-open')) {
        ...
        $('header').addClass('menu-open');
        $('.header-navigation-lessons').addClass('menu-open');    
        $(".header-navigation nav ul li a").addClass('current'); 
    }
